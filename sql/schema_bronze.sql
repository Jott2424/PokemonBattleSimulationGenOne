-- =============================================================================
-- Bronze-layer tables: raw Gen 1 reference data (games, pokemon, moves,
-- types, trainers, teams) that the silver simulation layer is built on top
-- of. Run this once against a fresh database before sql/schema_silver.sql.
--
-- Table order matches FK dependency order, so scripts/load_bronze_csvs.py
-- loads CSVs in this same order.
-- =============================================================================
